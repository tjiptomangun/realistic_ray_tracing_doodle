...
titik $B$ juga akan berhimpitan dengan $E$ dengan alasan $AB$ sama panjang
dengan $DE$. Jadi karena $AB$ berhimpitan dengan $DE$, maka ruas garis $AC$ 
juga akan berhimpitan dengan $DF$, dengan alasan $BAC$ sama panjang 
dengan $DEF$. Jadi titik $C$ juga akan berhimpitan dengan titik $F$, lagi
dikarenakan alasan $AC$ sama dengan $DF$. Tapi titik $B$ juga pasti
berhimpitan dengan titik $E$, sehinggan sisi alas $BC$ akan berhimpitan
dengan sisi alan $EF$. Karena jika $B$ berhimpitan dengan $E$,
