...
sama besar dengan sudut rektilinear tertentu, pada garis lurus tertentu.
...
dengan sudut rektilinier tertentu dari sebuah lingkaran.
...
Misalkan $ABC$ adalah sebuah lingkaran, dan $D$ adalah sudut rektilinear tertentu.
Jadi diperlukan untuk memotong sebuah tembereng, yang memiliki sudut pada busur
sama besar dengan sudut rektilinier $D$, dari lingkaran $ABC$.
...
rektilinear $D$, sudah dipotong dari lingkaran $ABC$. Yang adalah hal yang perlu
dilakukan.
