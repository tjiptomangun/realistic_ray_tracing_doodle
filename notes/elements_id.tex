...
\draw (6, 0) node [anchor=south] {D} --++(280:4.5) node[anchor=north]{C} --++ (37.5:1.91);
\draw (6, 0) --++(260:4.5) --++ (20.70:3.29);
\end{tikzpicture}
\end{center} 
...
kenyatannyannya, $BAC$ tidak sama dengan $EDF$. Karena juga benar maka sisi
...
menghadap salah satu sudut tadi, maka pada sisi - sisi selebihnya pada yang 
