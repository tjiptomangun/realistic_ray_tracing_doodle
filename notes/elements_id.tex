...
potongan, sama besar dengan jumlah dua kali jumlah besar persegi panjang yang dibentuk
keseluruhan garis dengan salah satu potongan tadi dengan besar bujur sangkar pada potongan
sisanya.
...
besar bujur sangkar salah satu potongan, sama besar dengan jumlah dua kali jumlah 
...
sangkar pada $AB$ dan $BC$ secara utuh.

Sebab misalkan $BD$ sudah ditarik memanjangkan (dengan lurus garis lurus $AB$)
...
misalkan bidang - bidang selebihnya sudah di gambarkan (Garis $ED$ dari $E$ ke $D$, $CH$ dan $BL$ sejajar
dengan $AE$, Dan melalui $K$ tarik $MN$ dan melalui $Q$ tarik $OP$, keduanya sejajar dengan $AD$).
...
$RN$ adalah sama besar satu dengan yang lain. Dengan demikian, keempatnya sekaligus
adalah empat kali lipat besar bujur sangkar $CK$. Dan lagi, karena $CB$ sama
panjang dengan $BD$, tetapi $BD$ sama panjang dengan $BK$ (sudut $AED$ dan $ADE$ sama besar karena $AE$ sama panjang dengan $AD$ [Prop. 1.8], dan sudut $BKD$ juga sama besar dengan sudut $ADE$ karena $BK$ sejajar $AE$ dan $ED$ memotong keduanya, penerjemah [Prop 1.28])- dan juga $CG$ - dan
...
sama panjang dengan $RP$, persegi panjang $AG$ sama besar dengan persegi panjang $MQ$, dan persegi panjang $QL$ sama besar dengan persegi panjang $RF$[Prop. 1.36]. Tetapi persegi panjang $MQ$ sama besar dengan persegi panjang $QL$. Karena keduanya adalah komplementer pada jajaran genkang $ML$ [Prop. 1.43]. Dengan 
demikian, keempat persegi panjang $AG$, $MG$, $QL$m dan $RF$ adalah sama besar
satu dengan yang lain. Dengan demikian jumlah besar keempatnya sama dengan empat kali lipat besar persegi panjang $AG$. Dan juga sudah ditunjukkan keempat
bujur sangkar $CK$, $KD$, $GR$ dan $RN$ jika digabungkan besarnya adalah empat
kali besar bujur sangkar $CK$. Dengan demikian, jika kedelapan bidang digabungkan, yang membentuk gnomon $STU$, adalah empat kali besar bersegi panjang $AK$.
...
besar bujur sangkar pada $AC$, sama dengan besar bujur sangkar pada $AD$. Dan $BD$ sama panjang dengan $BC$. Dengan demikian, empat kali persegi panjang yang dibentuk 
$AB$ dan $BC$, ditambah dengan bujur sangkar pada $AC$, sama besar dengan bujur sangkar pada $AD$, yang adalah bujur sangkar digambarkan pada $AB$ dan $BC$. 

Dengan demikian, jika sebuah garis lurus dipotong secara acak, maka empat kali besar
persegi panjang yang dibentuk oleh keseluruhan garis dengan salah satu potongannya, ditambah dengan besar bujur sangkar dari potongan selebihnya, sama besar dengan besar
bujur sangkar pada garis tersebut secara utuh  \footnote{Proposisi ini adalah versi geometri dari identitas aljabar $4(a + b)a + b^2 = [(a + b) + a]^2$} .
...
Jika sebuah garis lurus dipotong menjadi bagian - bagian yang besar dan tidak
...
Dengan demikian, jika sebuah garis lurus dipotong menjadi bagian - bagian yang besar dan tidak
sama panjang, maka jumlah dari besar bujur sangkar - bujur sangkar pada 
potongan - potongan yang
tidak sama panjang keseluruhan garis adalah dua kali jumlah dari jumlah besar
bujur sangkar pada setengah keseluruhan garis dan besar bujur sangkar pada
...
\draw [dotted, gray] ({sqrt(8*8 + 4*4) - 4}, -4) --++ (0: 4)
	--++(90:4) --++(180:4);
\end{tikzpicture}
\end{center}
...
jatuh secara tegak lurus, dan garis lurus yang memotong sisi luar 
(segitiga tersebut) dari garis tegak lurus kearah sudut tumpul.
...
dibentuk dari satu sisi yang yang mengapit sudut tumpul yang padanya garis lurus 
jatuh secara tegak lurus, dan garis lurus yang memotong sisi luar 
(segitiga tersebut) dari garis tegak lurus kearah sudut tumpul\footnote{Proposisi
