...
membentuk sudut - sudut interior sehadap yang jumlah besar 
...
tersebut (sisi yang jumlah sudut interior sehadap sama dengan dua sudut siku), 
dan tidak akan bertemu di sisi satunya.
\end{enumerate}
...
adalah jajaran genjang. Dengna demikian, $AB$ sama panjang dengan $DE$, dan 
...
\section*{\centering Proposisi \thesection} 
\addcontentsline{toc}{section}{Proposisi \thesection} 
Jika ada dua buah garis lurus, dan salah satunya dipotong - potong menjadi beberapa
potongan, maka besar persegi panjang yang dibentuk oleh kedua garis lurus sama 
dengan jumlah dari persegi panjang - persegi panjang yang dibentuk garis 
yang tidak dipotong dengan potongan - potongan garis yang dipotong.
...
Jika sebuah garis lurus dipotong disembarang titik, maka jumlah besar persegi
 panjang yang dibentuk oleh keseluruhan garis lurus dan potongan 
...
oleh garis lurus secara utuh dengan salah satu potongannya
\begin{center}
\begin{tikzpicture}
\end{tikzpicture}
\end{center}
