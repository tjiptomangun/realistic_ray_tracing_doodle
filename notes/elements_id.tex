...
Sebab misalkan sudah ditarik menyinggung $ABC$ [Prop. 3.17], dan misalkan pusat
...
dengan $AB$ atau $CD$, dan misallam $FK$ sudah ditarik dari $F$, sejajar dengan 
$AD$ atau $BC$ [Prop. 1.31]. Dengan demikian, $AK$, $KB$, $AH$, $HD$, $AG$, $GC$, 
$BG$ dan $GD$, masing - masing adalah jajaran genjang dari, dengan sisi - sisi
