...
%%	--++ (270:
%%https://tex.stackexchange.com/questions/22340/good-workaround-for-pgfmath-tikz-definition-of-inverse-cosine
	--++ ({acos((2*50 - 2*5*sqrt(2)*4*cos(55))/(2*sqrt(50+16 - 40*sqrt(2)*cos(55))*4))}: 
		5);	
