...
\begin{center} 
\begin{tikzpicture} 
\pgfmathparse {(1 + sqrt(5))/2}
\let \goldrat \pgfmathresult
\pgfmathparse {2}
\let \ac \pgfmathresult
\pgfmathparse {\ac*\goldrat}
\let \ab \pgfmathresult
\pgfmathparse {\ab - \ac}
\let \cb \pgfmathresult
\pgfmathparse {50}
\let \abdeg \pgfmathresult
\pgfmathparse {2}
\let \cd \pgfmathresult
\pgfmathparse {\cd/sin(36)}
\let \cdpersincad \pgfmathresult
\pgfmathparse {sqrt(2*\ac*\ac + 2*\ac*\ac*cos(108)}
\let \cdlength \pgfmathresult
\pgfmathparse {\ac*sin(\abdeg)/2 - tan(\abdeg- 90)*\ac*cos(\abdeg)/2}
\let \acpepcon \pgfmathresult
\pgfmathparse {\abdeg - 36}
\let \addeg \pgfmathresult
\pgfmathparse {\addeg + 180 - 36}
\let \dcdeg \pgfmathresult
\pgfmathparse {\ab*cos(\addeg)+\cd*cos(\dcdeg)/2}
\let \cdhalfx \pgfmathresult
\pgfmathparse {\ab*sin(\addeg)+\cd*sin(\dcdeg)/2}
\let \cdhalfy \pgfmathresult
\pgfmathparse {\ac*cos(\abdeg)/2}
\let \achalfx \pgfmathresult 
\pgfmathparse {\ac*sin(\abdeg)/2}
\let \achalfy \pgfmathresult
\pgfmathparse {\cdhalfy - tan(\dcdeg + 90)*\cdhalfx}
\let \cdpepcon \pgfmathresult
\pgfmathparse {(\cdpepcon - \acpepcon)/(tan(\abdeg  - 90) - tan(\dcdeg + 90))}
\let \fx \pgfmathresult
\pgfmathparse {tan(\abdeg - 90)*\fx + \acpepcon}
\let \fy \pgfmathresult
\pgfmathparse {sqrt(\fx*\fx + \fy*\fy)}
\let \frad \pgfmathresult


\draw (0, 0) node[anchor=east]{A} --++ (\abdeg:\ac) node [anchor=south]{C}
--++(\abdeg:\cb) node[anchor=west]{B};
\draw (0, 0) circle (\ab);
\draw [dashed, gray]({\ab*cos(\abdeg)}, {\ab*sin(\abdeg)}) circle(\ac);
\draw ({\ab*cos(\abdeg)}, {\ab*sin(\abdeg)}) 
--++({\abdeg + (72 - 180)}:\ac) node[anchor=west]{D} -- (0, 0); 
\draw ({\ab*cos(\abdeg)}, {\ab*sin(\abdeg)}) 
--++({\abdeg + (72 - 180)}:\ac) -- ({\ac*cos(\abdeg)}, {\ac*sin(\abdeg)});
\draw [dashed, gray]({\achalfx}, {\achalfy}) --++ ({\abdeg - 90}:1.45);
\draw [dashed, gray](\cdhalfx, \cdhalfy) --++ ({\dcdeg + 90}:1.45);
\draw (\fx, \fy) circle(\frad);
\end{tikzpicture} 
\end{center} 
...
\begin{center} 
\begin{tikzpicture} 
\pgfmathparse {sqrt(pow((2*cos(270+36) - 2*cos(270 - 36)), 2) + 
pow((2*sin(270+36)  - 2*sin(270 - 36)), 2))}
\let \cdlength \pgfmathresult

\draw ({5 + 2*cos(270-36)}, {2*sin(270 - 36)}) node[anchor=north east]{G} 
-- ({5 + 2*cos(270 + 36)},  {2*sin(270+36}) node[anchor=north west]{H}
-- ({5 + 2 * cos(90)}, {2*sin(90)}) node[anchor=south]{F}
-- ({5 + 2*cos(270-36)}, {2*sin(270 - 36)});

\draw (0, 0) circle(2);
\draw ({2*cos(270-36)}, {2*sin(270 - 36)}) node[anchor=north east]{C} 
-- ({2*cos(270 + 36)},  {2*sin(270+36}) node[anchor=north west]{D}
-- ({2 * cos(90)}, {2*sin(90)}) node[anchor=south]{A}
-- ({2*cos(270-36)}, {2*sin(270 - 36)}) 
--++ (108:\cdlength) node[anchor=east]{B} 
-- ({2*cos(270 + 36)},  {2*sin(270+36}) 
--++ ({180 - 108}:\cdlength) node[anchor=west]{E}
--({2*cos(270-36)}, {2*sin(270 - 36)})
--++(108:\cdlength)
--({2*cos(90)}, {2*sin(90)})
--++ ({270+(108/2)}: \cdlength); 
...
\section*{\centering Proposisi \thesection}
\addcontentsline{toc}{section}{Proposisi \thesection}
Untuk menggambarkan persegi lima yang memiliki sudut - sudut sama besar dan
sisi - sisi yang sama panjang yang membatasi sebuah lingkaran.  
\begin{center} 
\begin{tikzpicture} 
\pgfmathparse {sqrt(pow((2*cos(270+36) - 2*cos(270 - 36)), 2) + 
pow((2*sin(270+36)  - 2*sin(270 - 36)), 2))}
\let \cdlength \pgfmathresult 
\draw (0, 0) circle(2) node[anchor=south west]{F};
\draw [gray, dashed]({2*cos(270-36)}, {2*sin(270 - 36)}) node[anchor=north east]{C} 
%% 36 is cad angle
%% 72 is adc angle
%% 108 is bcd angle (which is 36  + 72)
-- ({2*cos(270 + 36)},  {2*sin(270+36})
-- ({2 * cos(90)}, {2*sin(90)}) 
-- ({2*cos(270-36)}, {2*sin(270 - 36)}) 
--++ (108:\cdlength) 
...
\draw ({2*cos(270-36)}, {2*sin(270 - 36)}) node[anchor=north east]{C} 
	...
	--({2*cos(270 + 36)},  {2*sin(270+36}) node[anchor=north west]{D};
\draw (0, 0)
	-- ({2*cos(270 - 36 - 72)}, {2*sin(270 - 36 - 72)}) node[anchor=east]{B};
\draw (0, 0)
	--({2*cos(270 + 36 + 72)},  {2*sin(270+36 + 72}) node[anchor=west]{E};
\draw (0, 0) -- ({2*cos(90)}, {2*sin (90)}) node [anchor=south]{A}; 


\pgfmathparse {tan(270 - 36 + 90)}
\let \gradcl \pgfmathresult
\pgfmathparse {tan(270 + 36 -90)}
\let \graddl \pgfmathresult 
...
%%m1x11 - m1x01 + y01 = y11
%%y01 - m1x01 = c1
\pgfmathparse {2*sin(270 - 36) - 2*cos(270 - 36)*\gradcl }
\let \constcl \pgfmathresult
\pgfmathparse {2*sin(270 + 36) - 2*cos(270 + 36)*\graddl}
\let \constdl \pgfmathresult
\pgfmathparse {(\constdl - \constcl)/(\gradcl - \graddl)}
\let \lx \pgfmathresult
\pgfmathparse {\gradcl * \lx + \constcl}
\let \ly \pgfmathresult 
\pgfmathparse {2*cos(270+36)}
\let \dx \pgfmathresult 
\pgfmathparse {2*sin(270+36)}
\let \dy \pgfmathresult 
\pgfmathparse {2*cos(270-36)}
\let \cx \pgfmathresult 
\pgfmathparse {2*sin(270-36)}
\let \cy \pgfmathresult 
\pgfmathparse {sqrt((\dx - \lx)*(\dx - \lx) + (\dy - \ly)*(\dy - \ly))}
\let \dllen \pgfmathresult
\pgfmathparse {atan(\graddl)}
\let \angledl \pgfmathresult
\pgfmathparse {2*cos(270 - 36 - 72)}
\let \bx \pgfmathresult 
\pgfmathparse {2*sin(270 - 36 - 72)}
\let \by \pgfmathresult
\pgfmathparse {-1 * \gradcl}
\let \gradck \pgfmathresult
\pgfmathparse {sqrt(\lx*\lx + \ly*\ly)}
\let \fllen \pgfmathresult

\draw (\cx, \cy) 
	-- (\lx, \ly) node[anchor=north] {L} -- (0, 0);
\draw (\lx, \ly) -- (\dx, \dy) 
	--++ (\angledl:\dllen) node[anchor=west]{M}
	--++ ({\angledl + 72}:{\dllen*2}) node[anchor=south west]{G}
	--++ ({\angledl + 2*72}:{\dllen*2}) node[anchor=south east]{H}
	--++ ({\angledl + 3*72}:{\dllen*2}) node[anchor=south east]{K}
	--++ ({\angledl + 4*72}:{\dllen});
\draw (0, 0) -- ({\fllen*cos(270 - 72)}, {\fllen*sin(270 - 72)});
...
\section*{\centering Proposisi \thesection}
\addcontentsline{toc}{section}{Proposisi \thesection} 
Untuk menggambarkan sebuah lingkaran yang dibatasi sebuah segilima
yang sama sisi dan sudut - sudut yang sama besar.
\begin{center} 
\begin{tikzpicture} 
\pgfmathparse {108/2}
\let \dcfangle \pgfmathresult
\pgfmathparse {180 - (108/2)}
\let \cdfangle \pgfmathresult
\pgfmathparse {-1.5} 
\let \cx \pgfmathresult
\pgfmathparse {0}
\let \cy \pgfmathresult
...
\pgfmathparse {0}
\let \dy \pgfmathresult
\pgfmathparse {\cy - tan(\dcfangle)*\cx}
\let \cfconst \pgfmathresult 
\pgfmathparse {\dy - tan(\cdfangle)*\dx}
\let \dfconst \pgfmathresult 
\pgfmathparse {(\dfconst - \cfconst)/(tan(\dcfangle) - tan(\cdfangle))}
\let \fx \pgfmathresult
\pgfmathparse {tan(\dcfangle)*\fx + \cfconst}
\let \fy \pgfmathresult 
\pgfmathparse {sqrt((\dx - \fx)*(\dx - \fx) + (\dy - \fy)*(\dy -  \fy))}
\let \dflength \pgfmathresult 

\pgfmathparse {sqrt((\fx)*(\fx) + (\fy)*(\fy))}
\let \dklength \pgfmathresult 
\draw(1.5, 0) node[anchor=north west]{D} 
--++(180:3) node[anchor=north east]{C}
--++ (108: 3) node[anchor=east]{B} 
--++ ({108 - 72}:3) node[anchor=south]{A} 
--++ ({108 - 72*2}:3) node[anchor=west]{E}
--++ ({108 - 72*3}:3);
\draw (1.5, 0) -- (\fx, \fy)
	-- (-1.5, 0);
\draw (0.7, 2.6) node {F};
\draw (\fx, \fy) --++ (90: \dflength);
\draw (\fx, \fy) --++ ({90 - 72}: \dflength);
\draw (\fx, \fy) --++ ({90 + 72}: \dflength); 
\draw (\fx, \fy) --++ (270: \dklength) node[anchor=north]{K};
\draw (\fx, \fy) --++ ({270 - 72}: \dklength) node[anchor=east]{H};
\draw (\fx, \fy) --++ ({270 - 2*72}: \dklength) node[anchor=south east]{G};
\draw (\fx, \fy) --++ ({270 - 3*72}: \dklength) node[anchor=south west]{M};
\draw (\fx, \fy) --++ ({270 - 4*72}: \dklength) node[anchor=west]{L};
\draw (\fx, \fy) circle(\dklength);
\end{tikzpicture} 
\end{center}
Misalkan $ABCDE$ adalah persegi lima dengan sudut - sudut sama besar dan
sisi - sisi sama panjang. Jadi diperlukan untuk menggambarkan lingkaran
yang dibatasi oleh segilima $ABCDE$.
...
\begin{center} 
\begin{tikzpicture} 
\pgfmathparse {sqrt(pow(3*(cos(270 + 36) - cos(270 - 36)), 2.0) +
pow(3*(sin(270 + 36) - sin(270 - 36)), 2.0))}
\let \cdlength \pgfmathresult
\draw ({3*cos(270 - 36)}, {3*sin(270 - 36)}) node[anchor=north east]{C} --
 ({3*cos(270 + 36)}, {3*sin(270 + 36)}) node[anchor=north west]{D} --++
 (72:\cdlength) node[anchor=west]{E} --++
 ({72*2}:\cdlength) node[anchor=south]{A} --++
 ({72*3}:\cdlength) node[anchor=east]{B} --++
 ({72*4}:\cdlength) -- (0, 0) -- 
 ({3*cos(270 + 36)}, {3*sin(270 + 36)}) -- (0, 0)
 ({3*cos(270 + 36 + 72)}, {3*sin(270 + 36 + 72)}) -- (0, 0)
 ({3*cos(270 + 36 + 2*72)}, {3*sin(270 + 36 + 2*72)}) -- (0, 0)
 ({3*cos(270 + 36 + 3*72)}, {3*sin(270 + 36 + 3*72)}) -- (0, 0)
 node [anchor=south west]{F} circle (3);
...
\begin{tikzpicture} 
\draw(0, 0) circle(2.5);
\draw(0, .2) node[anchor=south west]{G};
\draw(0, 2.5) circle(2.5) node[anchor=south]{D};
\draw({2.5*cos(30)}, {2.5*sin(30)}) node[anchor=west]{E}
-- (0, 0) 
-- ({2.5*cos(210)}, {2.5*sin(210)}) node[anchor=east]{B};
\draw({2.5*cos(150)}, {2.5*sin(150)}) node[anchor=east]{C}
-- (0, 0) 
-- ({2.5*cos(330)}, {2.5*sin(330)}) node[anchor=west]{F};
\draw(0, -2.5) node[anchor=north]{A} --++ (90:5);

\draw(0, 2.5) circle(2.5) 
 -- ({2.5*cos(30)}, {2.5*sin(30)})
 -- ({2.5*cos(330)}, {2.5*sin(330)}) 
 -- (0, -2.5) node[anchor=north]{A} 
 -- ({2.5*cos(210)}, {2.5*sin(210)}) 
 -- ({2.5*cos(150)}, {2.5*sin(150)}) 
 -- (0, 2.5) circle(2.5);
\draw (0, 5) node[anchor=south]{H};
\end{tikzpicture} 
\end{center} 
...
\section*{\centering Proposisi \thesection}
\addcontentsline{toc}{section}{Proposisi \thesection} 
Untuk menggambarkan segilimabelas dengan sisi - sisi sama panjang dan 
sudut - sudut sama besar.
\begin{center} 
\begin{tikzpicture} 
\pgfmathparse {3}
\let \rad \pgfmathresult
\pgfmathparse {sqrt(pow(\rad*(cos(90 - 120) - cos(90 + 120)), 2.0) +
pow(\rad*(sin(90 - 120) - sin(90 + 120)), 2.0))}
\let \cdlength \pgfmathresult
\pgfmathparse {sqrt(pow(\rad*(cos(270 + 36) - cos(270 - 36)), 2.0) +
pow(\rad*(sin(270 + 36) - sin(270 - 36)), 2.0))}
\let \pentagonlen \pgfmathresult 
%% f is angle on pentagon on the right of tringle angle of  c
\pgfmathparse {sqrt(pow(\rad*(cos(90 + 120) - cos(270 - 36)), 2.0) +
pow(\rad*(sin(90 + 120) - sin(270 - 36)), 2.0))} 
\let \cflength \pgfmathresult
\pgfmathparse {360/15} 
\let \crfangle \pgfmathresult
%% r is center of circle , so crf is angle that is formed  by line cr and rf
%% so we are using the same strategy as in pentagon inscribed in a circle
%% using center of circle and the two points at the bottom of the figure we
%% want to build, using symetrical angle division , since we are using
%% positive vertical as the top of the figure.
\draw(0, 0) circle(\rad);
\draw ({\rad*cos(90)}, {\rad*sin(90)}) node[anchor=south]{A} --
({\rad*cos(90 - 120)}, {\rad*sin(90 - 120)}) node[anchor=west]{D} --
({\rad*cos(90 + 120)}, {\rad*sin(90 + 120)}) node[anchor=east]{C} --
({\rad*cos(90)}, {\rad*sin(90)});
\draw ({\rad*cos(270 - 36)}, {\rad*sin(270 - 36)}) --
 ({\rad*cos(270 + 36)}, {\rad*sin(270 + 36)}) --++
 (72:\pentagonlen) --++
 ({72*2}:\pentagonlen) --++
 ({72*3}:\pentagonlen) node[anchor=east]{B}--++
 ({72*4}:\pentagonlen); 
\draw ({\rad*cos(270 - \crfangle/2)}, {\rad*sin(270 - \crfangle/2)}) --
({\rad*cos(270 + \crfangle/2)}, {\rad*sin(270 + \crfangle/2)})
--++ (\crfangle: \cflength) 
--++ ({2*\crfangle}: \cflength) 
--++ ({3*\crfangle}: \cflength)
--++ ({4*\crfangle}: \cflength)
...
--++ ({8*\crfangle}: \cflength)
--++ ({9*\crfangle}: \cflength)
--++ ({10*\crfangle}: \cflength)
--++ ({11*\crfangle}: \cflength)
--++ ({12*\crfangle}: \cflength)
--++ ({13*\crfangle}: \cflength)
--++ ({14*\crfangle}: \cflength);
\end{tikzpicture} 
\end{center} 
Misalkan $ABCD$ adalah lingkaran tertentu. Jadi diperlukan untuk menggambarkan
persegi limabelas yang dibatasi lingkaran $ABCD$.
...
\chapter*{\centering \chaptername{ \thechapter} 
\addcontentsline{toc}{chapter}{Buku \thechapter}
Proposisi(Kesebandingan)\footnote{Teori proposisi pada buku ini secara umum dikaitkan
dengan Euxodus dari Cnidus. Hal baru yang menonjol dari teori ini adalah
kemampuannya untuk menangani besaran irasional, yang sampai saat itu 
adalah batu sandungan bagi para matematikawan Yunani. Diseluruh catatan
kaki di buku ini, $\alpha$, $\beta$, $\gamma$, dll, 
melambangkan besaran {irasional yang mungkin}, sedangkan $m$, $n$, $l$, 
dll, melambangkan bilangan bulat positif}.}
\pagebreak
\begin{center} 
\addcontentsline{toc}{section}{Definisi - definisi}
\textbf{Definisi - Definisi}
...
masing - masing, terhadap besaran - besaran yang lain yang sama banyak 
anggotanya dengan kumpulan pertama, maka besarnya/banyaknya satu besaran dari 
...
\draw(0, 0) node[anchor=south]{A} 
--++ (90:.1) --++(270:.2) --++(90:.1)
--++(0:2) node[anchor=south]{G} 
--++ (90:.1) --++(270:.2) --++(90:.1)
--++(0:2) node[anchor=south]{B} 
--++ (90:.1) --++(270:.2) --++(90:.1)
;
\draw(5, 0) node[anchor=south]{C} 
--++ (90:.1) --++(270:.2) --++(90:.1)
--++(0:2) node[anchor=south]{H} 
--++ (90:.1) --++(270:.2) --++(90:.1)
--++(0:2) node[anchor=south]{D} 
--++ (90:.1) --++(270:.2) --++(90:.1)
;
\draw(0, -1) node[anchor=east]{E} 
--++ (90:.1) --++(270:.2) --++(90:.1)
--++(0:2) 
--++ (90:.1) --++(270:.2) --++(90:.1)
;
\draw(5, -1) node[anchor=east]{F}
--++ (90:.1) --++(270:.2) --++(90:.1)
--++(0:2)
--++ (90:.1) --++(270:.2) --++(90:.1)
;
...
\begin{center} 
\begin{tikzpicture} 
\draw(0, 0) node[anchor=east]{F} --++(90:.1) --++ (270:.2) 
--++(90:.1) --++ (0: 1.5) --++(90:.1) --++ (270:.2) --++(90:.1); 
\draw(0, 1) node[anchor=south]{D} 
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++ (0: 1.5) --++(90:.1) --++ (270:.2) --++(90:.1)
--++(0:1.5)
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:1.5)
--++(90:.1) --++ (270:.2) --++(90:.1) 
...
--++(90:.1) --++ (270:.2) --++(90:.1) 
node[anchor=south]{H} ;
\draw(0, 2) node[anchor=east]{C} --++(90:.1) --++ (270:.2) 
--++(90:.1) --++ (0: 1) --++(90:.1) --++ (270:.2) --++(90:.1); 
\draw(0, 3) node[anchor=south]{D} 
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++ (0: 1) --++(90:.1) --++ (270:.2) --++(90:.1)
--++(0:1)
--++(90:.1) --++ (270:.2) --++(90:.1) 
...
\stepcounter{section}
\section*{\centering Proposisi \thesection\footnote{Dalam notasi modern, 
notasi ini dinyatakan sebagai $m(n\alpha)= (mn)\alpha$}}
\addcontentsline{toc}{section}{Proposisi \thesection} 

Jika sebuah besaran pertama dan besaran ketiga masing - masing adalah kelipatan
yang sama dari besaran kedua dan keempat, dan kelipatan yang sama diterapkan
pada masing - masing besaran pertama dan ketiga, maka melalui kesamaan, 
besaran - besaran yang didapat dari pelipatan lain tadi juga 
adalah kelipatan yang sama dari masing - masing
besaran kedua dan keempat.
...
--++(0:1)
--++(90:.1) --++ (270:.2) --++(90:.1);
\draw(0, -2) node[anchor=east]{E} 
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:3) node[anchor=south]{K}
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:3) node[anchor=south]{F} 
--++(90:.1) --++ (270:.2) --++(90:.1);
\draw(0, -3) node[anchor=east]{C} 
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:.5)
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:.5)
...
--++(0:.5)
--++(90:.1) --++ (270:.2) --++(90:.1);
\draw(0, -4) node[anchor=east]{D}
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:.5)
--++(90:.1) --++ (270:.2) --++(90:.1); 
\draw(0, -5) node[anchor=east]{G} 
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:1.5) node[anchor=south]{L}
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:1.5) node[anchor=south]{H} 
--++(90:.1) --++ (270:.2) --++(90:.1);
\end{tikzpicture} 
\end{center}
Sebab misalkan besaran pertama $A$ dan besaran ketiga $C$ adalah kelipatan yang
sama dari masing - masing bilangan kedua $B$ dan keempat $D$, dan misalkan 
kelipatan yang sama $EF$ dan $GH$ sudah diterapkan pada masing - masing $A$ dan
$C$. Saya katakan $EF$ dan $GH$ adalah kelipatan yang sama dari masing - masing
$B$ dan $D$.

Sebab karena $EF$ dan $GH$ adalah kelipatan yang sama dari masing - masing $A$
dan $C$, dengan begitu sedemikian banyak besaran yang ada di $EF$ yang sama
besar dengan $A$, sedemikian banyak juga besaran yang ada di $GH$ yang sama
besar dengan $C$. Misalkan $EF$ sudah dibagi menjadi besaran - besaran $EK$,
$KF$, sama besar dengan $A$, dan $GH$ menjadai besaran - besaran $GL$, $LH$
yang sama besar dengan $C$. Sehingga, numblah besaran - besaran $EK$ dan 
$KF$ juga sama dengan jumlah besaran - besaran $GL$, $LH$. Dan karena
$A$ dan $C$ adalah kelipatan yang sama dari masing - masing $B$ dan $D$, dan
$EK$ sama besar dengan $A$ dan $GL$ sama besar dengan $C$, $EK$ dan $GL$ dengan
demikian adalah kelipatan - kelipatan yang sama dari masing - masing $B$ dan
$D$. Jadi, dengan alasan - alasan yang sama, $FK$ dan $LH$ adalah kelipatan
- kelipatan yang sama dari masing - masing $B$ dan $D$. Karena itu, sebab
besaran pertama $EK$ dan ketiga $GL$ adalah kelipatan yang sama dari masing -
masing besaran kedua $B$ dan keempat $D$, dan besaran kelima $KF$ dan keenam
$LH$ juga adala kelipatan - kelipatan yang sama dari masing - masing besaran 
kedua dan keempat, maka jumlah bearan pertama dan kelima, yang menghasilkan $EF$,
dan jumlah besaran ketiga dan keenam, mengkhasilkan $GH$, juga adalah kelipatan 
- kelipatan yang sama dari masing - masing besaran kedua dan keempat 
[Prop. 5.2].

Dengan demikian, jika besaran pertama dan besaran ketiga adalah kelipatan yang
sama dari besaran kedua dan besaran keempat, dan kelipatan yang sama sudah 
diterapkan pada besaran pertama dan ketiga, maka besaran - besaran hasil terapan
tadi juga akan merupakan kelipatan yang sama dari masing - masing besaran - 
besaran kedua dan keempat. Yang adalah hal yang perlu ditunjukkan.

\stepcounter{section}
\section*{\centering Proposisi \thesection\footnote{Dalam notasi modern, 
notasi ini dinyatakan sebagai jika $\alpha:\beta::\gamma:\delta$ maka
$m\alpha : n\beta :: m\gamma : n\delta$ untuk semua $m$ dan $n$.}}
\addcontentsline{toc}{section}{Proposisi \thesection} 

Jika rasio besaran pertama dan kedua sama dengan rasio besaran ketiga dengan
bilangan keempat, maka kelipatan yang sama dari besaran pertama dan ketiga 
akan memiliki rasio yang sama besar dengan kelipatan yang sama lainnya terhadap
bilangan kedua dan keempat, diambil dalam urutan yang sesuai.

\begin{center} 
\begin{tikzpicture} 
\pgfmathparse {1}
\let \alength \pgfmathresult
\pgfmathparse {.4}
\let \blength \pgfmathresult 
\pgfmathparse {.6}
\let \clength \pgfmathresult 
\pgfmathparse {.3}
\let \dlength \pgfmathresult
\pgfmathparse {2}
\let \mula \pgfmathresult 
\pgfmathparse {4}
\let \mulb \pgfmathresult
\draw(0, 9) node[anchor=east]{A} 
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:\alength)
--++(90:.1) --++ (270:.2) --++(90:.1) ; 
\draw(0, 8) node[anchor=east]{B} 
...
--++(0:\blength)
--++(90:.1) --++ (270:.2) --++(90:.1) ; 
\draw(0, 7) node[anchor=east]{E} 
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:\alength)
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:\alength)
--++(90:.1) --++ (270:.2) --++(90:.1); 
\draw(0, 6) node[anchor=east]{G} 
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:\blength)
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:\blength)
...
--++(0:\blength)
--++(90:.1) --++ (270:.2) --++(90:.1); 
\draw(0, 5) node[anchor=east]{K} 
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:\alength*\mula)
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:\alength*\mula)
--++(90:.1) --++ (270:.2) --++(90:.1); 
\draw(0, 4) node[anchor=east]{M} 
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:\blength*\mulb)
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:\blength*\mulb)
...
--++(0:\dlength)
--++(90:.1) --++ (270:.2) --++(90:.1) ; 
\draw(0, 1) node[anchor=east]{F} 
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:\clength)
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:\clength)
--++(90:.1) --++ (270:.2) --++(90:.1); 
\draw(0, 0) node[anchor=east]{H} 
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:\dlength)
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:\dlength)
...
--++(0:\dlength)
--++(90:.1) --++ (270:.2) --++(90:.1); 
\draw(0, -1) node[anchor=east]{L} 
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:\clength*\mula)
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:\clength*\mula)
--++(90:.1) --++ (270:.2) --++(90:.1); 
\draw(0, -2) node[anchor=east]{N} 
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:\dlength*\mulb)
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:\dlength*\mulb)
...
\end{tikzpicture} 
\end{center}
Sebab misalkan rasio besaran pertama $A$ terhadap besaran 
kedua $B$ sama dengan dengan rasio $C$ terhadap $D$. Dan misalkan kelipatan - 
kelipatan yang sama besar $E$ dan $F$ sudah didapat dari  masing - masing $A$ 
dan $C$, dan sembarang kelipatan yang sama besar lain $G$ dan $H$ sudah 
didapat dari masing - masing $B$ dan $D$. Saya katakan perbandingan $E$ 
terhadap $G$ sama besar dengan perbandingan $F$ terhadap $H$.

Sebab misalkan kelipatan - kelipatan sama besar $K$ dan $L$ sudah didapat dari
masing - masing $E$ dan $F$ , dan masing - masing kelipatan kelipatan sama
besar $M$ dan $N$ sudah didapat dari masing - masing $G$ dan $H$.

Dan karena $E$ dan $F$ adalah kelipatan - kelipatan yang sama besar dari masing -
masing $A$ dan $C$, dan masing - masing kelipatan - kelipatan sama besar $K$
dan $L$ sudah didapat dan masing - masing $E$ dan $F$, $K$ dan $L$ dengan 
demikian adalah kelipatan - kelipatan sama besar dari masing - masing $A$ dan
$C$ [Prop. 5.3]. Jadi dengan alasan - alasan yang sama, $M$ dan $N$ adalah 
kelipatan - kelipatan sama besar dari masing - masing $B$ dan $D$. Dan karena
rasio $A$ dan $B$ sama besar dengan rasio $C$ dan $D$, dan kelipatan - 
kelipatan sama besar $K$ dan $L$ sudah didapat dari masing - masing $A$ dan $C$,
dan kelipatan - kelipatan sama besar sembarang lainnya $M$ dan $N$ sudah didapat
dari $B$ dan $D$, maka jika $K$ lebih besar dari $M$ maka $L$ juga akan lebih
besar dari $N$, dan jika $K$ sama besar dengan $M$ maka $L$ juga sama besar 
dengan $N$, dan jika $K$ lebih kecil dari $M$ maka $L$ juga lebih kecil dari 
$N$ [Def. 5.5]. Dan $K$ dan $L$ adalah kelipatan - kelipatan sama besar
dari masing - masing $E$ dan $F$, dan $M$ dan $N$ adalah sembarang kelipatan - 
kelipatan sema besar dari masing - masign $G$ dan $H$. Dengan demikian
rasio $E$ terhadap $G$ sama degan rasion $F$ terhadap $H$ [Def. 5.5].

Dengan demikian, jika rasio besaran pertama terhadap besaran kedua sama dengan
rasio besaran ketiga dengan besaran keempat, maka kelipatan - kelipatan sama
besar dari besaran pertama dan ketiga juga akan memiliki rasio sama besar 
dengan kelipatan - kelipatan sama besar lainnya dari besaran kedua dan keempat,
diambil dengan urutan yang sesuai. Yang adalah hal yang perlu ditunjukkan.  
...
Jika sebuah besaran (pertama) adalah kelipatan sebuah 
besaran (kedua) lainnya, dan
bagian yang diambil dari besaran pertama adalah kelipatan yang sama 
dengan bagian diambil dari besaran kedua, maka sisa pengurangan dari besaran
pertama adalah kelipatan yang sama dari sisa pengurangan besaran kedua, yang
adalah perbandingan besaran pertama dengan besaran kedua.

\begin{center}
\pgfmathparse {3}
\let \mult \pgfmathresult
\pgfmathparse {2/3}
\let \pone \pgfmathresult 
\pgfmathparse {1/3} 
\let \ptwo \pgfmathresult 
\pgfmathparse {2} 
\let \smallpart \pgfmathresult 
\begin{tikzpicture} 
\draw(0, 0) node[anchor=south]{A} 
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:{\smallpart*\pone}) 
...
Sebab misalkan besaran $AB$ adalah kelipatan $CD$, dan $AE$ adalah bagian yang
diambil dari $AB$ dan adalah kelipatan yang sama (besar dengan kelipatan sebelumnya) dari bagian $CF$ yang diambil
dari $CD$. Saya katakan bahwa sisanya $EB$ juga adalah kelipatan yang sama
dari sisa $FD$, yang mana adalah perbandingan $AB$ dengan $CD$.

Sebab, sebanyak bagian di $AE$ yang habis dibagi oleh $CF$, sedemikian pula
bagian misalnya $EB$ yang habis dibagi oleh $CG$.

Dan karena $AE$ dan $EB$ adalah kelipatan - kelipatan yang sama dari masing - 
masing $CF$ dan $GC$, $AE$ dan $AB$ dengan demikian juga adalah kelipatan - 
kelipatan yang sama besar terhadap masing - masing $CG$ dan $GF$ [Prop. 5.1].
Dan $AE$ dan $AB$ diasumsikan kelipatan - kelipatan yang sama dari masing - 
masing $CF$ dan $CD$. Dengan demikian, $AB$ adalah kelipatan yang sama dari
masing - masing $GF$ dan $CD$. Dengan demikian, $GF$ juga sama besar dengan $CD$.
Misalkan $CF$ sudah dikurangkan dari keduanya. Dengan demikian, sisa $GC$ sama
besar dengan sisa $FD$. Dan karena $AE$ dan $EB$ adalah kelipatan - kelipatan
yang sama dari masing - masing $CF$ dan $GC$, dan $GC$ sama besar dengan $DF$, 
$AE$ dan $EB$ dengan demikian kelipatan - kelipatan yang sama dari masing - masing
$CF$ dan $FD$. Dan $AE$ dan $AB$ diasumsikan kelipatan - kelipatan yang sama
dari masing - masing $CF$ dan $CD$. Dengan demikian, $EB$ dan $AB$ adalah kelipatan
- kelipatan yang sama dari masing - masing $FD$ dan $CD$. Dengan demikian, sisa 
$EB$ juga akan sama dengan kelipatan yang sama dari sisa $FD$, yang mana adalah
perbandingan keseluruhan $AB$ dengan $CD$.

Jadi jika dua, dimana  besaran yang besaran pertama adalah kelipatan besaran 
kedua, dan bagian
yang diambil dari besaran pertama adalah kelipatan yang sama juga dari bagian
yang diambil dari besaran kedua, maka sisa besaran pertama juga adalah kelipatan
yang sama yang dari sisa besaran kedua, yang adalah perbandingan keseluruah 
 besaran pertama 
terhadap keseluruhan besaran kedua. Yang adalah hal yang perlu ditunjukkan.

\stepcounter{section}
\section*{\centering Proposisi \thesection\footnote{Dalam notasi modern, 
notasi ini dinyatakan sebagai $m\alpha - n\alpha = (m - n)\alpha$ }}
Jika dua besaran adalah kelipatan - kelipatan yang sama dari dua besaran yang
lain, dan beberapa bagian yang diambil (dari besaran - besaran pertama) adalah
kelipatan - kelipatan yang sama dari bagian - bagian yang sama yang diambil
dari masing - masing besaran - besaran kedua, maka sisa - sisa nya akan
sama besar dengan besaran - besaran kedua atau sama besar dengan 
kelipatan - kelipatan yang sama dari sisa - sia dari besaran - besaran kedua.
\begin{center}
\pgfmathparse {2}
\let \po \pgfmathresult
\pgfmathparse {1.4}
\let \pt \pgfmathresult
\begin{tikzpicture} 
\draw(0, 4) node[anchor=south]{A} 
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:{\po}) 
...
--++(90:.1) --++ (270:.2) --++(90:.1)
node[anchor=south]{D};
\draw(0, 1) node[anchor=south]{F} 
--++(90:.1) --++ (270:.2) --++(90:.1) 
--++(0:{\pt}) 
--++(90:.1) --++ (270:.2) --++(90:.1) ;
\end{tikzpicture} 
\end{center}
Misalkan dua besaran $AB$ dan $CD$ adalah kelipatan - kelipatan yang sama dari
masing - masing dua besaran $E$ dan $F$. Dan misalkan masing - masing bagian yang 
diambil dari besaran - besaran pertama $AG$ dan $CH$ adalah kelipatan - kelipatan
yang sama dari masing - masing $E$ dan $F$. Saya katakan bahwa sisa - sisa $GB$ 
dan $HD$ adalah sama besar dengan masing - masing $E$ dan $F$ atau kelipatan -
kelipatan yang sama dari $E$ dan $F$.

Sebab misalkan pertama $GB$ sama besar dengan $E$. Saya katakan bahwa $HD$ juga
sama besar dengan $F$.

Sebab misalkan $CK$ sudah dibuat sama besar dengan $F$. Dan karena $AG$ dan $CD$
adalah kelipatan - kelipatan sama besar dari masing - masing $E$ dan $F$, dan
$GB$ sama besar dengan $E$, dan $KC$ sama besar $F$, $AB$ dan $KH$ dengan demikian
juga sama besar dengan kelipatan - kelipatan yang sama dengan masing - masing 
$E$ dan $F$ [Prop. 5.2]. Dan $AB$ dan $CD$ diasumsikan sama besar dengan kelipatan
- kelipatan sama besar dari masing - masing $E$ dan $F$. Dengan demikian, $KH$ dan
$CD$ adalah kelipatan - kelipatan sama besar dari masing - masing $F$ dan $F$.
Karena itu, $KH$ dan $CD$ masing - masing adalah kelipatan sama besar dari $F$.
Dengan demikian $KH$ sama besar dengan $CD$. Misalkan $CH$ sudah diambil dari 
keduanya. Dengan demikian, sisa $KC$ sama besar dengan sisa $HD$. Tetapi, $F$
sama besar dengan $KC$. Dengan demikian, $HD$ juga sama besar dengan $F$. Dengan
demikian, jika $GB$ sama besar dengan $E$, maka $HD$ juga akan sama besar 
dengan $F$.

Jadi, dengan cara yang sama dapat ditunjukkan jika $GB$ adalah kelipatan dari
$E$ maka $HD$ juga adalah kelipatan dari $F$.

Dengan demikian, jika dua besaran - besaran pertama adalah kelipatan dari 
besaran - besaran kedua, dan bagian - bagian yang diambil dari besaran - 
besaran pertama adalah kelipatan yang sama dari bagian - bagian yang diambil dari
masing - masing besaran - besaran kedua, maka sisa - sisa nya juga akan akan sama
besar dengan besaran - besaran kedua atau kelipatan - kelipatan yang sama dari
besaran - besaran kedua. Yang adalah hal yang perlu ditunjukkan.
