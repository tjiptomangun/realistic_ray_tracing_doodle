...
sudut yang sama besar, atau yang didalamnya sudut - sudut sama besar satu 
dengan yang lain.
\end{enumerate}
...
sudah dibagi di tengah sama panjang di $D$ [Prop. 1.9]. Dan misalkan $DC$ sudah
...
memotong di tengah sembarang tali busur lainnya yang tidak melalui pusat 
...
tali busur melalui pusat lingkaran, $CD$, memotong di tengah sembarang tali
...
melalui pusat lingkaran memotong di tengah sembarang garis lurus lainnya yang 
...
yang lainnya tepat di tengah. (Walaupun salah satu bisa memotong yang lainnya 
tepat di tengah).
...
Sebab, jika mungkin, misalkan keduanya saling memotong di tengah, sehingga $AE$
...
garis $FE$ memotong di tengah garis lainnya $BD$, maka ia memotongnya secara
...
Yang adalah mustahil (Karena keduanya disebutkan berpotongan).
 Dengan demikian, $AC$ dan $BD$ tidak saling memotong di tengah.

Dengan demikian, pada sebuah lingkaran, jika dua buah tali busur, tidak 
melalui pusat lingkaran,
saling memotong satu dengan yang lain, maka keduanya tidak akan saling memotong 
yang lainnya tepat di tengah. (Walaupun salah satu bisa memotong yang lainnya 
tepat di tengah).  Yang adalah hal yang perlu ditunjukkan.  

\begin{center}
\textbf{Dalil}
\end{center}
Jika dua tali busur lingkaran saling memotong di tengah, maka keduanya adalah 
diameter lingkaran.
