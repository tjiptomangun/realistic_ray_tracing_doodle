...
\section*{\centering Proposisi \thesection}
\addcontentsline{toc}{section}{Proposisi \thesection}
Pada sebuah lingkaran, sudut di dalam (pada busur) sebuah setengah lingkaran adalah sudut
...
- siku. Dan lebih jauh, sudut dari (yang diapit oleh) sebuah tembereng yang 
lebih besar dari setengah lingkaran adalah lebih besar dari sudut siku - siku,
dan sudut
dari (yang diapit) sebuah tembereng yang lebih kecil dari setengah lingkaran
...
dihubungkan. Saya katakan bahwa sudut $BAC$ di dalam (pada busur) 
...
Dengan demikian, di dalam sebuah lingkaran, sudut di dalam tembereng setengah 
...
lebih besar dari sudut siku - siku. Dan lebih jauh, sudut dari sebuah 
temberang yang lebih besar dari setengh lingkaran adalah lebih besar dari 
sudut siku - siku, dan sudut dari tembereng yang lebih kecil dari setengah
...
$ADC$, yang ada dalam setengah lingkaran, adalah sudut siku - siku [Prop. 3.31].
