...
\end{tikzpicture}
\end{center}
Misalkan $EBC$ dan $DEF$ adalah segitiga - segitiga yang berada sisi alas yang
...
$GH$ [Prop. 1.36]. Dan segitiha $ABC$ adalah setengah dari jajaran genjang 
...
pada sisi alas yang sama $BC$, dan berada pada sisi yang sama. Saya katawan 
...
garis lurus $BC$ [Prop. 1.31], dan mislkan $EC$ sudah dihubungkan. Dengan 
